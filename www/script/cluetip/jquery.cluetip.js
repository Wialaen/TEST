 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    leftOffset:       -30,       // Number of px to offset clueTip from left of invoking element
    ...
    closeText:        '<img src="css/cross.gif" alt="close" />',  // text (or HTML) to to be clicked to close sticky clueTips
